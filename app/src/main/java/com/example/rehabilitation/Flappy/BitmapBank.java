...
public class BitmapBank {
    ...
    public BitmapBank(Resources res) {
        ...
        bird = new Bitmap[4];
        bird[2] = BitmapFactory.decodeResource(res, R.drawable.abird1);
        bird[3] = BitmapFactory.decodeResource(res, R.drawable.abird2);
        bird[0] = BitmapFactory.decodeResource(res, R.drawable.abird1);
        bird[1] = BitmapFactory.decodeResource(res, R.drawable.abird2);
